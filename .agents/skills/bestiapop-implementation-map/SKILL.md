...
| Descubrir | `ui/screens/discover/DiscoverScreen.kt` (`DiscoverTopSearchBar`, `DiscoverCategoryChipsRow`, `DiscoverRecentSearchesView`, `DiscoverHomeFeedView`, `DiscoverSearchResultsView`, `DiscoverCollectionDetailView`, `DiscoverAdvancedFiltersPanel`) |
...
| `GetDiscoverRecommendationsUseCase` | `domain/usecase/GetDiscoverRecommendationsUseCase.kt` | Generador del feed de recomendaciones para Discover (ListenBrainz CF si token activo, Deezer related/top por artistas más escuchados, charts Deezer como fallback) |
