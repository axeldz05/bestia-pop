...
| Ajustes / Reproducción | `ui/screens/PlaybackSettingsScreen.kt` (`SettingsScreen` sección `Playback`; slider online; Batería separa `blocksBackgroundPlayback` vs Doze; copy `backgroundRestrictionGuidance`; botón OEM `openOemScreenOffCleanupSettings` solo si `oemScreenOffCleanupActive`) |
