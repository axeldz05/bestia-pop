...
| Artwork UI | `ui/components/ArtworkThumbnail.kt` (`rememberArtworkRequest` + `Precision.INEXACT` + `LocalAllowArtworkDecode`; `ArtworkThumbnail`, `ArtworkHero`); `ui/components/ArtworkPicker.kt` (`ArtworkPickerBlock`, `rememberImagePicker`) |
