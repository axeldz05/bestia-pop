...
| Ajustes / Biblioteca | `ui/screens/LibrarySettingsScreen.kt` (`SettingsScreen` sección `Library`; scroll rápido vertical estilo Niagara on/off + borde derecho/izquierdo para zurdos vía `FastScrollSettings`) |
